...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_palladium.cpp
LOCAL_MODULE := libhealthd.palladium
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_palladium_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := palladium_charger_res_images
LOCAL_MODULE_TAGS := optional

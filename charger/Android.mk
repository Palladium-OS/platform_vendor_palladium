...
# Set palladium_charger_density to the density bucket of the device.
palladium_charger_density := mdpi
ifneq (,$(TARGET_SCREEN_DENSITY))
palladium_charger_density := $(strip \
...
palladium_charger_density := $(PRODUCT_AAPT_PREF_CONFIG)
endif

include $(CLEAR_VARS)
LOCAL_MODULE := palladium_charger_battery_scale
LOCAL_MODULE_STEM := battery_scale.png
LOCAL_SRC_FILES := $(palladium_charger_density)/battery_scale.png
...
include $(CLEAR_VARS)
LOCAL_MODULE := palladium_charger_battery_fail
LOCAL_MODULE_STEM := battery_fail.png
LOCAL_SRC_FILES := $(palladium_charger_density)/battery_fail.png
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_PRODUCT_ETC)/res/images/charger
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE := palladium_charger_animation
LOCAL_MODULE_STEM := animation.txt
LOCAL_SRC_FILES := animation.txt
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_PRODUCT_ETC)/res/values/charger
LOCAL_REQUIRED_MODULES := palladium_charger_battery_scale palladium_charger_battery_fail
include $(BUILD_PREBUILT)

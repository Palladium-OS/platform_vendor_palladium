#
# Palladium Audio Files
#

ALARM_PATH := vendor/palladium/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/palladium/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/palladium/prebuilt/common/media/audio/ringtones

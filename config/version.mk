...
PALLADIUM_RELEASE_VERSION = v1.3
...
PALLADIUM_BUILD_DATE := $(PALLADIUM_DATE_YEAR)$(PALLADIUM_DATE_MONTH)$(PALLADIUM_DATE_DAY)-$(PALLADIUM_DATE_HOUR)$(PALLADIUM_DATE_MINUTE)
PALLADIUM_BUILD_VERSION := $(PALLADIUM_RELEASE_VERSION)
PALLADIUM_BUILD_FINGERPRINT := Palladium/$(PALLADIUM_MOD_VERSION)/$(TARGET_PRODUCT_SHORT)/$(PALLADIUM_BUILD_DATE)
